import pandas as pd
from  ETL.tiki_extraction import extract_all_category, extract_all_products_from_category, extract_category_infomation
import psycopg2, unicodedata
from psycopg2 import extras
import sys, constants.tiki_information as tiki_info
